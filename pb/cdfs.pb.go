...
var file_cdfs_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x32, 0x0a, 0x0e, 0x52, 0x65, 0x61, 0x64,
	0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x12, 0x20, 0x0a, 0x0b, 0x63, 0x68,
	0x75, 0x6e, 0x6b, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0b, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x22, 0x2b, 0x0a, 0x0f,
	0x52, 0x65, 0x61, 0x64, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x12,
	0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x69, 0x0a, 0x07, 0x52, 0x65, 0x61,
	...
	0x00, 0x32, 0x91, 0x02, 0x0a, 0x0b, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x65,
	...
	0x43, 0x68, 0x75, 0x6e, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x38, 0x0a, 0x0b, 0x52,
	0x65, 0x61, 0x64, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x2e, 0x70, 0x62, 0x2e,
	0x52, 0x65, 0x61, 0x64, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x1a, 0x13,
	0x2e, 0x70, 0x62, 0x2e, 0x52, 0x65, 0x61, 0x64, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x52,
...
var file_cdfs_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_cdfs_proto_goTypes = []interface{}{
	...
	(*CreateChunkReq)(nil),   // 16: pb.CreateChunkReq
	(*CreateChunkResp)(nil),  // 17: pb.CreateChunkResp
	(*ReadVersionReq)(nil),   // 18: pb.ReadVersionReq
	(*ReadVersionResp)(nil),  // 19: pb.ReadVersionResp
	(*ReadReq)(nil),          // 20: pb.ReadReq
	(*ReadResp)(nil),         // 21: pb.ReadResp
	(*AppendDataReq)(nil),    // 22: pb.AppendDataReq
	(*AppendDataResp)(nil),   // 23: pb.AppendDataResp
	(*ReplicateReq)(nil),     // 24: pb.ReplicateReq
	(*ReplicateResp)(nil),    // 25: pb.ReplicateResp
}
var file_cdfs_proto_depIdxs = []int32{
	...
	11, // 7: pb.CreateChunkResp.status:type_name -> pb.Status
	11, // 8: pb.ReadResp.status:type_name -> pb.Status
	11, // 9: pb.AppendDataResp.status:type_name -> pb.Status
	11, // 10: pb.ReplicateResp.status:type_name -> pb.Status
	0,  // 11: pb.Master.GetToken:input_type -> pb.GetTokenReq
	4,  // 12: pb.Master.GetLocation:input_type -> pb.GetLocationReq
	7,  // 13: pb.Master.AppendFile:input_type -> pb.AppendFileReq
	8,  // 14: pb.Master.Delete:input_type -> pb.DeleteReq
	9,  // 15: pb.Master.Create:input_type -> pb.CreateReq
	14, // 16: pb.Master.HeartBeat:input_type -> pb.HeartBeatPayload
	2,  // 17: pb.Master.CSRegister:input_type -> pb.CSRegisterReq
	16, // 18: pb.ChunkServer.CreateChunk:input_type -> pb.CreateChunkReq
	18, // 19: pb.ChunkServer.ReadVersion:input_type -> pb.ReadVersionReq
	20, // 20: pb.ChunkServer.Read:input_type -> pb.ReadReq
	22, // 21: pb.ChunkServer.AppendData:input_type -> pb.AppendDataReq
	24, // 22: pb.ChunkServer.Replicate:input_type -> pb.ReplicateReq
	1,  // 23: pb.Master.GetToken:output_type -> pb.GetTokenResp
	5,  // 24: pb.Master.GetLocation:output_type -> pb.GetLocationResp
	13, // 25: pb.Master.AppendFile:output_type -> pb.AppendFileResp
	12, // 26: pb.Master.Delete:output_type -> pb.DeleteStatus
	10, // 27: pb.Master.Create:output_type -> pb.CreateResp
	15, // 28: pb.Master.HeartBeat:output_type -> pb.HeartBeatResp
	3,  // 29: pb.Master.CSRegister:output_type -> pb.CSRegisterResp
	17, // 30: pb.ChunkServer.CreateChunk:output_type -> pb.CreateChunkResp
	19, // 31: pb.ChunkServer.ReadVersion:output_type -> pb.ReadVersionResp
	21, // 32: pb.ChunkServer.Read:output_type -> pb.ReadResp
	23, // 33: pb.ChunkServer.AppendData:output_type -> pb.AppendDataResp
	25, // 34: pb.ChunkServer.Replicate:output_type -> pb.ReplicateResp
